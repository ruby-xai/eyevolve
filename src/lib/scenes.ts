  ...
  },
  {
    ...
    after: {
      objects: [
        { id: "school-road", type: "road", x: 320, y: 236, w: 660, h: 66, rotation: 0 },
        { id: "school-building", type: "building", x: 322, y: 118, w: 150, h: 86 },
        { id: "stalled-bus", type: "car", x: 320, y: 236, w: 92, h: 30, rotation: 3, status: "hazard" },
        { id: "queue-1", type: "car", x: 224, y: 236, w: 46, h: 23, status: "action" },
        { id: "queue-2", type: "car", x: 174, y: 236, w: 46, h: 23, status: "action" },
        { id: "crossing-marker", type: "marker", x: 318, y: 202, w: 150, h: 48, status: "action" },
    ...
    changes: [
      {
        id: "stalled-bus",
        label: "Large vehicle blocking crossing",
        description: "A large vehicle is stopped at the school crossing.",
        objectIds: ["stalled-bus", "crossing-marker"],
        coordinates: { x: 320, y: 236 },
        features: fw({ humanSafety: 0.88, urgency: 0.78, infrastructure: 0.68, behavioral: 0.72 }),
        suggestedAction: "Contact traffic control",
      },
      {
        id: "school-queue",
    ...
    learningTargets: fw({ humanSafety: 0.92, urgency: 0.74, behavioral: 0.72, infrastructure: 0.62 }),
    exposure: fw({ humanSafety: 0.92, urgency: 0.78, infrastructure: 0.68, behavioral: 0.74, visualNoise: 0.48 }),
    recommendedAction: "Contact traffic control",
    actionService: "Traffic Control Desk",
  },
  {
